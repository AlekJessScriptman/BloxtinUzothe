...
local BuyFruitEvent = RemoteEvents:FindFirstChild("BuyFruit")
...
-- Inputs
local npcBox = createTextBox("Enter NPC name")
local speedBox = createTextBox("Tween speed (max 250)")
speedBox.Text = "150"
...
createToggleButton("Auto Farm", function(on) states.farming = on end)
createToggleButton("Auto Attack", function(on) states.autoAttack = on end)

createLabel("🍉 Equip Fruit")
createToggleButton("Equip Fruit", function(on) states.equipFruit = on end)

createLabel("👣 Follow Player")
createToggleButton("Follow", function(on) states.follow = on end)

createLabel("🎯 Aimbot")
createToggleButton("Aimbot", function(on) states.aimbot = on end)

createLabel("💰 Auto Trade")
createToggleButton("Auto Add Fruits", function(on) states.autoFruitTrade = on end)
createToggleButton("Auto Accept Trade", function(on) states.autoTradeAccept = on end)

createLabel("📦 Collect Chest")
createToggleButton("Auto Collect Chest", function(on) states.autoCollectChest = on end)

createLabel("🛍️ Free Shopping")
createToggleButton("Free Shop", function(on) states.freeShop = on end)
